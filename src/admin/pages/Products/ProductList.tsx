                    ...
                    >
                      <td className="px-6 py-4">
                        ...
                        <div className="text-xs text-slate-500 mt-0.5 flex items-center gap-1">
                          ...
                          {product.category} • {product.subscriptionType} ({product.durationMonths}m)
                        </div>
                      </td>
                      <td className="px-6 py-4">
                        ...
                        {product.oldPrice > 0 && (
                          <div className="text-xs text-slate-500 line-through">${product.oldPrice.toFixed(2)} Retail</div>
                        )}
                      </td>
                      <td className="px-6 py-4">
