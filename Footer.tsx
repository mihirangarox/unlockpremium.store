        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-neutral-500">
              <li><button onClick={() => onSetView('how-it-works')} className="hover:text-indigo-400 transition-colors text-left">How It Works</button></li>
              <li><button onClick={() => onSetView('plans')} className="hover:text-indigo-400 transition-colors text-left">Plans</button></li>
              <li><button onClick={() => onSetView('guides')} className="hover:text-indigo-400 transition-colors text-left">Guides</button></li>
