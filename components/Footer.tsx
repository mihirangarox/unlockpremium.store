          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-4">
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.1, rotate: -5 }}
                className="w-10 h-10 rounded-full bg-neutral-900 border border-white/5 flex items-center justify-center text-neutral-500 hover:text-indigo-400 hover:border-indigo-400/50 transition-colors group"
              >
