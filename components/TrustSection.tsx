...
// Lightweight IntersectionObserver hook — triggers CSS .reveal class, no framer-motion
...
const TrustSection: React.FC = memo(() => {
  ...
  return (
    <section ref={sectionRef} id="trust" className="py-24 bg-neutral-950 border-y border-white/5">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {FEATURES.map((item, i) => (
            <div
              key={item.title}
              className={`reveal reveal-d${i + 1} glass p-8 rounded-3xl border border-white/5 group
